...
export const AGENT_CATEGORY_COLORS: Record<string, { bg: string; color: string; border: string }> = {
  ...
  market: { bg: "rgba(168,85,247,0.08)", color: "#D4A843", border: "rgba(168,85,247,0.25)" },
  legal: { bg: "rgba(236,72,153,0.08)", color: "#B8860B", border: "rgba(236,72,153,0.25)" },
  cultural: { bg: "rgba(20,184,166,0.08)", color: "#14B8A6", border: "rgba(20,184,166,0.25)" },
  operations: { bg: "rgba(99,102,241,0.08)", color: "#8B6F4E", border: "rgba(99,102,241,0.25)" },
};
...
export const ENTITY_COLORS: Record<string, { bg: string; color: string; border: string }> = {
  ...
  company: { bg: "rgba(168,85,247,0.08)", color: "#D4A843", border: "rgba(168,85,247,0.15)" },
  market: { bg: "rgba(168,85,247,0.08)", color: "#D4A843", border: "rgba(168,85,247,0.15)" },
