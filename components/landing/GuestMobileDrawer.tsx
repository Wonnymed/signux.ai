    ...
    <>
      ...
      >
        <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
          <Link href="/" onClick={onClose} className="flex items-center gap-2 text-white/90">
            <span
              className="h-2 w-2 rounded-full"
              style={{ backgroundColor: '#e8593c', boxShadow: '0 0 10px rgba(232,89,60,0.5)' }}
            />
            <span className="text-[15px] font-medium">Octux</span>
          </Link>
          <button
            type="button"
            onClick={onClose}
